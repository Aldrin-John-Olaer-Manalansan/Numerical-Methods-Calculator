...
# installed.
TCL_PREFIX='C:/maxima-5.43.0'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/maxima-5.43.0'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/tmp/Gloeckl/maxima-5.43.0/crosscompile-windows/build/tcltk/tcl-prefix/src/tcl-build -ltcl86'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-LC:/maxima-5.43.0/lib -ltcl86'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/maxima-5.43.0/include'
...
# compiled.
TCL_SRC_DIR='/tmp/Gloeckl/maxima-5.43.0/crosscompile-windows/build/tcltk/tcl-prefix/src/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='C:/maxima-5.43.0/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/tmp/Gloeckl/maxima-5.43.0/crosscompile-windows/build/tcltk/tcl-prefix/src/tcl-build -ltclstub86'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/maxima-5.43.0/lib -ltclstub86'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/Gloeckl/maxima-5.43.0/crosscompile-windows/build/tcltk/tcl-prefix/src/tcl-build/libtclstub86.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='C:/maxima-5.43.0/lib/libtclstub86.a'
