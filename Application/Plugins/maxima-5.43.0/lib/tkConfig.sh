...
# installed.
TK_PREFIX='C:/maxima-5.43.0'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='C:/maxima-5.43.0'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/tmp/Gloeckl/maxima-5.43.0/crosscompile-windows/build/tcltk/tk-prefix/src/tk-build -ltk86'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-LC:/maxima-5.43.0/lib -ltk86'
...
# compiled.
TK_SRC_DIR='/tmp/Gloeckl/maxima-5.43.0/crosscompile-windows/build/tcltk/tk-prefix/src/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/tmp/Gloeckl/maxima-5.43.0/crosscompile-windows/build/tcltk/tk-prefix/src/tk-build -ltkstub86'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-LC:/maxima-5.43.0/lib -ltkstub86'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/tmp/Gloeckl/maxima-5.43.0/crosscompile-windows/build/tcltk/tk-prefix/src/tk-build/libtkstub86.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='C:/maxima-5.43.0/lib/libtkstub86.a'
