...
#define VALID_FILENAME_CHAR ((ch >= 32) && (ch <= 61) && (ch != 34) && (ch != 42) && (ch != 47) && (ch != 58) && (ch != 60)) || ((ch >= 64) && (ch != 92) && (ch != 124) && (ch != 162) && (ch != 179) && (ch != 190))
...
#ifndef IN_MODULE_CC
register long STACK_reg __asm__("%ebx");
struct registers { long STACK_register_contents; };
...
#define end_call()  ; ; ;; saved_STACK = (gcv_object_t*)((void *)0)
#define begin_callback()  do { struct registers * registers = __builtin_alloca((sizeof(struct registers))); registers->STACK_register_contents = STACK_reg; ; ; ; STACK = saved_STACK;; { gcv_object_t* top_of_frame = STACK; ((STACK[-1-(sintP)(-1)]) = ((gcv_object_t)((oint)((aint)callback_saved_registers))), STACK -= -1); ((STACK[-1-(sintP)(-1)]) = (gcv_object_t)((oint)(((1UL<<(31))|(1UL<<((31-2)))|(1UL<<((31-3)))|(1UL<<((31-5)))))+(oint)((uintP)(STACK - -1)-(uintP)(top_of_frame))), (STACK -= (sintP)(-1))); } callback_saved_registers = registers; } while(0); ; ; ;; saved_STACK = (gcv_object_t*)((void *)0)
#define end_callback()  ; ; ;; do { struct registers * registers = callback_saved_registers; if (!(((oint)(((STACK[-1-(sintP)(0)]))) & (-1L<<((31-5)))) == ((1UL<<(31))|(1UL<<((31-2)))|(1UL<<((31-3)))|(1UL<<((31-5)))))) abort(); callback_saved_registers = (struct registers *)(aint)(oint)(((STACK[-1-(sintP)(1)]))); (STACK -= (sintP)(2)); saved_STACK = STACK;; STACK_reg = registers->STACK_register_contents; ; ; ; } while(0)
#define begin_system_call()  ; ; ;; saved_STACK = STACK
#define end_system_call()  ; ; ;; saved_STACK = (gcv_object_t*)((void *)0)
#define begin_blocking_system_call()  ; ; ;; saved_STACK = STACK;
#define end_blocking_system_call()  ; ; ;; saved_STACK = (gcv_object_t*)((void *)0);
#define begin_blocking_call()  
#define end_blocking_call()  
#define GC_SAFE_CALL(type,statement)  do { ; type statement; ; } while(0)
#define GC_SAFE_SYSTEM_CALL(type,statement)  do { ; ; ;; saved_STACK = STACK;; type statement; ; ; ;; saved_STACK = (gcv_object_t*)((void *)0);; } while(0)
...
extern struct symbol_tab_ {
  ...
  symbol_ S_shell_name;
  symbol_ S_shell;
  symbol_ S_launch;
  symbol_ S_shell_execute;
  symbol_ S_savemem;
...
extern struct object_tab_ {
  ...
  gcv_object_t backslash_string;
  gcv_object_t backslashbackslash_string;
  gcv_object_t lnk_string;
  gcv_object_t dot_string;
  gcv_object_t dotdot_string;
  gcv_object_t dotdotdot_string;
  gcv_object_t backupextend_string;
  gcv_object_t default_drive;
  ...
  gcv_object_t load_extra_file_types;
...
#define CALLBACK_frame_info  ((1UL<<(31))|(1UL<<((31-2)))|(1UL<<((31-3)))|(1UL<<((31-5))))
...
extern object sec_usec_number(uint32 sec, uint32 usec, _Bool abs_p);
extern void builtin_stream_close(const gcv_object_t* stream_, uintB abort);
extern HANDLE stream_lend_handle(gcv_object_t *stream_, _Bool inputp, int * handletype);
extern object open_file_stream_handle(object stream, HANDLE *fd, _Bool permissive_p);
extern sint64 handle_length(gcv_object_t *stream_, HANDLE fd);
...
extern void stream_handles(object obj, _Bool check_open, _Bool* char_p, SOCKET* in_sock, SOCKET* out_sock);
...
#define START_WRITING_TO_SUBPROCESS  
#define STOP_WRITING_TO_SUBPROCESS  
...
#define convert_time_to_universal_w32 convert_time_to_universal
#define convert_time_from_universal_w32 convert_time_from_universal
