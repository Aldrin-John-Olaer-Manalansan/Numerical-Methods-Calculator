...
(defparameter *autoconf-prefix* "C:/maxima-5.43.0")
(defparameter *autoconf-exec_prefix* "C:/maxima-5.43.0")
(defparameter *autoconf-package* "maxima")
(defparameter *autoconf-version* "5.43.0")
(defparameter *autoconf-libdir* "C:/maxima-5.43.0/lib")
(defparameter *autoconf-libexecdir* "C:/maxima-5.43.0/libexec")
(defparameter *autoconf-datadir* "C:/maxima-5.43.0/share")
(defparameter *autoconf-infodir* "C:/maxima-5.43.0/share/info")
...
(defparameter *maxima-source-root* "/tmp/Gloeckl/maxima-5.43.0/crosscompile-windows/build/maxima-prefix/src/maxima")
